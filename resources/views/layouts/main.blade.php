...
<script>
  $(document).ready(function() {
    ...
    function formatColor(color) {
      ...
      var $color = $(
        '<span><span style="display: inline-block; width: 20px; height: 20px; background: #' + $(color.element).data('color') + '; margin-right: 5px; border: 1px solid #ddd;"></span>' + color.text + '</span>'
      );
      return $color;
    }
  });
